...
app.controller("IndexCtrl", function($scope, $http, $rootScope, $modal) {
	...
	$scope.subPageItem=JSON.parse(localStorage.getItem("subPageItem"));
	console.log($scope.subPageItem)
	$scope.gitGroupList = $scope.subPageItem.subInfo.groups;
	$scope.purl = $scope.subPageItem.subInfo.posturl;
	$scope.nameCN = $scope.subPageItem.nameCN;
